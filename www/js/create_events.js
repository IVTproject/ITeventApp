...
function creat_block(event) {
   ...
   return "<a class='a_event' href='#event_page' onclick='get_event_information(" + event.id + ")'><div class='event'> <div class='event_all'> <div class='event_ava'>" +
...
function get_inform_event(event_inform) {
    ...
    if(localStorage.getItem("first_name") && localStorage.getItem("second_name")) {
        document.getElementsByName('first_name')[0].value = localStorage.getItem("first_name");
        document.getElementsByName('second_name')[0].value = localStorage.getItem("second_name");
    }
}
